                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form autocomplete="on" id="login-form" action="./login" method="post"> 
                                <h1>Log in</h1> 
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form id="register-form" action="./register" autocomplete="on" method="post"> 
                                <h1> Sign up </h1> 
                                <p> 
                                ...
                                <p> 
                                    ...
                                    <input id="passwordsignup_confirm" name="passwordsignup_confirm" required="required" type="password" placeholder="eg. X8df!90EO" required oninput="check()"/>
                                </p>
                                <script>
									    function check() {
									        if (document.getElementById('passwordsignup_confirm').value != document.getElementById('passwordsignup').value) 
									        {
									        	document.getElementById('passwordsignup_confirm').setCustomValidity('Password Must be Matching.');
									        } 
									        else 
									        {
